...
DATABASES = {
    'default': {
        ...
        'USER': config('DB_USER'),  # Usuario que creaste en PostgreSQL
        'PASSWORD': config('DB_PASSWORD'),  # Contraseña del usuario
        'HOST': config('DB_HOST'),  # El servidor local
        'PORT': config('DB_PORT', cast=int),  # Puerto predeterminado de PostgreSQL
    }
}
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    'C:/Users/tomiv/OneDrive/Desktop/SistemaWeb/myproject/static',
]
